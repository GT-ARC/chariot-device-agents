...
public class WSEndpoint extends WebSocketClient {
    ...
    public static final String simulatedTray = "storage-service";
    public static final String trayDriver = "storage-driver-id";
    public static final String getStatusOf = "getStatusOf";
    public static final String status = "status";
    public static final String type = "type";
    public static final String defaultStatus = "Free";
    public String trayModel = "storage-tray";; // default storage tray

    public static final String storageStates = "storagestates";
    ...
    public void updateResult(JsonObject storage) {
        JsonObject obj = storage.get(storageStates).getAsJsonObject();
        for(int i = 1; i < 20; i ++){
            String tray =  "tray-"+i;
