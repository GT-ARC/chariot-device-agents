package de.gtarc.chariot.hx711sensoragent1.iolite;
...
public class DeviceBean extends DeviceAgentForRE {
    ...
    private final static String ACTION_UPDATE_ENTITY_PROPERTY = "de.gtarc.chariot.hx711sensoragent1.DeviceBean#updateProperty";
