package de.gtarc.chariot.hx711sensoragent3;
...
public class DeviceBean extends DeviceAgent {
    // actions
    public static final String ACTION_GET_WEIGHT = "de.gtarc.chariot.hx711sensoragent2.DeviceBean#getWeight";
...
//        }
    ...
    @IMethodExposingBean.Expose(name = ACTION_GET_WEIGHT, scope = ActionScope.NODE, returnTypes = {Integer.class})
    ...
    @IMethodExposingBean.Expose(name = ACTION_GET_NUMBER_OF_OBJECTS, scope = ActionScope.NODE, returnTypes = {Integer.class})
