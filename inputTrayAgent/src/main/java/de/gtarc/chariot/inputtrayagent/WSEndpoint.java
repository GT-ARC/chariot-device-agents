...
public class WSEndpoint extends WebSocketClient {
    ...
    public String trayModel = "input-container-tray";;
    public static final String getStatusOf = "getStatusOf";
    public static final String status = "status";
    public static final String type = "type";
    public static final String simulatedTray = "input-container-service";
    public static final String trayDriver = "input-container-driver-id";
    public static final String inputContainerStates = "inputcontainerstates";
    ...
    public void updateResult(JsonObject storage) {
        JsonObject obj = storage.get(inputContainerStates).getAsJsonObject();
        for(int i = 1; i < 9 ; i ++){
            String tray =  "tray-"+i;
